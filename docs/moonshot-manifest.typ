...
// Title
#align(center)[
  #text(size: 22pt, weight: "bold", fill: rgb("#003366"))[Moonshots XXIII Launch Manifest]
  #v(4pt)
  #text(size: 14pt, fill: rgb("#666666"))[RBAC Builder]
  #v(12pt)
]
...
#text(size: 14pt, weight: "bold", fill: rgb("#003366"))[Page Properties]
#v(6pt)
...
#table(
  ...
  inset: 8pt,
  fill: (col, row) => if col == 0 { rgb("#f5f5f5") } else { white },

  [*Team Name / Title*], [RBAC Builder],
  [*Participants*], [\@Arif Shaikh],
  [*Demo Link*], [#link("https://customroles.streamlit.app")[customroles.streamlit.app]],
  [*Project Status*], [WIP],
...
// Problem
#text(size: 16pt, weight: "bold", fill: rgb("#003366"))[Problem]
#v(6pt)
...
#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[Scenario \#1: The Blank Page Problem]
#v(4pt)

An SA sits down with a new enterprise customer (say, 5 teams, 3 projects, 4 environments) and faces: _"Who should get what permissions?"_ Today, the SA opens a Google Sheet, manually cross-references Terraform modules, looks up action names in internal source code, hand-writes JSON policy statements, and hopes they got the scoping right. One missed environment tag or a typo in an action name means a broken deployment. This process takes 2--4 hours per customer and is error-prone.

#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[Scenario \#2: No Visibility Into Existing RBAC Health]
#v(4pt)
...
#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[Scenario \#3: AI Configs Permissions Gap]
#v(4pt)
...
// Proposal
#text(size: 16pt, weight: "bold", fill: rgb("#003366"))[Proposal]
#v(6pt)

*RBAC Builder is a Python/Streamlit application with three core capabilities:*

#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[1. Visual Permission Matrix]
#v(4pt)

A spreadsheet-like UI where SAs check/uncheck permissions across a Teams #sym.times Permissions #sym.times Environments grid. Project-scoped actions (createFlag, archiveFlag, manageMetrics) and environment-scoped actions (updateTargeting, applyChanges, manageSegments) are cleanly separated. The matrix supports critical/non-critical environment grouping, AI Config permissions, observability actions, and tag-based environment filtering --- all driven by authoritative action definitions.

#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[2. Sage --- AI Role Designer]
#v(4pt)
...
#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[3. Deployment Pipeline]
#v(4pt)
...
#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[Companion Tool: Policy Explorer]
#v(4pt)
...
#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[Architecture]
#v(4pt)
...
#v(8pt)
#text(size: 12pt, weight: "bold", fill: rgb("#333333"))[Impact]
#v(4pt)
